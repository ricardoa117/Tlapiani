...
// ============================================================
// TLAPIANI — Instructivo de uso (6 pasos)
// ============================================================
...
// FIX: Paleta actualizada de verde a guinda/dorado (coherente con el resto de la app)
const styles: Record<string, React.CSSProperties> = {
    ...
    intro: {
        ...
        borderRadius: '1rem', padding: '2rem', marginBottom: '2rem', textAlign: 'center' as const,
    },
    introTitle: { margin: '0 0 1rem', fontSize: '1.6rem', color: '#b8860b' },
    introText: {
        margin: 0, color: '#ccc', lineHeight: 1.7,
    ...
    card: {
        background: 'rgba(107,26,42,0.35)', border: '1px solid rgba(184,134,11,0.4)',
        borderRadius: '1rem', padding: '1.75rem', display: 'flex',
    ...
    footer: {
        ...
        borderRadius: '1rem', padding: '1.5rem', textAlign: 'center' as const,
    },
